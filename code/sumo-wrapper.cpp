...
//	string xmlfile = c.getPath() + to_string(t) + "-" + c.getName() + ".add.xml";
	string xmlfile = c.getPath() + c.getName() + ".add.xml";
...
//	string name2 = c.getPath() + to_string(t) + "-" + c.getName(); // generated files by this application

	// Input files:
	cmd += "-n " + name1 + ".net.xml "; // Network file
	cmd += "-r " + name1 + ".rou.xml "; // Routes file
	cmd += "-a " + name1 + ".add.xml "; // TL file 
...
//	cmd += "--emission-output " + name1 + "-emissions.xml "; // Emissions result
	cmd += "--summary-output " + name1 + "-summary.xml "; // Summary result
	cmd += "--vehroute-output " + name1 + "-vehicles.xml "; // Vehicle routes result
	cmd += "--tripinfo-output " + name1 + "-tripinfo.xml "; // tripinfo result
...
void analyzeTripInfo(const cInstance &c, time_t t, tStatistics &s)
{
//	string filename = c.getPath() + to_string(t) + "-" + c.getName() + "-tripinfo.xml";
	string filename = c.getPath() + c.getName() + "-tripinfo.xml";
...
void analyzeSummary(const cInstance &c, time_t t, tStatistics &s)
{
//	string filename = c.getPath() + to_string(t) + "-" + c.getName() + "-summary.xml";
	string filename = c.getPath() + c.getName() + "-summary.xml";
...
void analyzeEmissions(const cInstance &c, time_t t, tStatistics &s)
{
//	string filename = c.getPath() + to_string(t) + "-" + c.getName() + "-emissions.xml";
	string filename = c.getPath() + c.getName() + "-emissions.xml";
	string line;
	ifstream fin(filename.c_str());
	map<string, string> m;
	int position;
